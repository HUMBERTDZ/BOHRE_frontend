            ...
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
              ...
              <div className="flex-1 space-y-2">
                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                  <h1 className="text-3xl font-bold text-balance">{fullName}</h1>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-medium">{formatDate(user.fechaNacimiento)}</p>
                </div>
              </div>
              <div className="space-y-1">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-1">
                  ...
                  <p className="font-medium font-mono">{user.cedulaProfesional}</p>
                </div>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                {user.numeroSemestre && (
                  <div className="space-y-1">
                    ...
                    <p className="font-medium">{user.numeroSemestre}° Semestre</p>
                  </div>
                )}
                ...
                {user.situacion && (
                  <div className="space-y-1">
                    ...
                    <Badge variant="outline">{user.situacion}</Badge>
                  </div>
                )}
                {user.fechaIngresoGeneracion && (
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">Fecha de Ingreso</p>
                    <p className="font-medium">{formatDate(user.fechaIngresoGeneracion)}</p>
                  </div>
                )}
                {user.fechaEgresoGeneracion && (
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">Fecha de Egreso</p>
                    <p className="font-medium">{formatDate(user.fechaEgresoGeneracion)}</p>
                  </div>
                )}
              </div>
            </CardContent>
