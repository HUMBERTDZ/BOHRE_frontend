  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-between py-4">
        <Input className="max-w-sm" placeholder="Filtrar por grupo..." value={(table.getColumn("grupo")?.getFilterValue() as string) ?? ""}
          onChange={(event) => table.getColumn("grupo")?.setFilterValue(event.target.value)
          }
        />
